...
fn extra_models() -> Vec<ModelInfo> {
    vec![
        ...
        ModelInfo {
            id: "github-copilot/claude-sonnet-4".into(),
        ...
        ModelInfo {
            id: "github-copilot/gpt-4.1".into(),
            name: "GPT-4.1".into(),
            provider: "github-copilot".into(),
        ...
        ModelInfo {
            id: "github-copilot/gpt-4.1-mini".into(),
        ...
        ModelInfo {
            id: "github-copilot/o4-mini".into(),
            name: "o4-mini".into(),
            provider: "github-copilot".into(),
            context_window: Some(200000),
            tool_call: true,
        ...
        ModelInfo {
            id: "github-copilot/gemini-2.5-pro".into(),
